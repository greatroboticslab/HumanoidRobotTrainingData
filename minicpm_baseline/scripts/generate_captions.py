...
for f in onlyFolders:
    ...
    caption_cpm.MakeCaptionsFromFolder(_folder, "../output/fullcaptions/" + f + "/")
    shutil.copytree("../output/fullcaptions/"+f+"/", "../../video_processing/minicpm_captions/"+f+"/", dirs_exist_ok=True)
