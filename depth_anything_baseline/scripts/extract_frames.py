...
def main():
    ...
    for video in _videos:
        ...
        if video:
            ...
            frame_paths = [f for f in os.listdir("../../video_processing/frames/" + videoIndex + "/raw_frames/") if f.lower().endswith('.jpg')]
            for i in range(len(frame_paths)):
                frame_paths[i] = "../../video_processing/frames/" + videoIndex + "/raw_frames/" + frame_paths[i]
            print(frame_paths)
